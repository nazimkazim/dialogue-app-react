...
export default {
  ...
  instructions: {
    engInstruction: "Practice the dialogue",
    rusInstruction: "Практикуйте диалог"
  },
  description:
    "The dialogue aims at improving basic conversational skills, such as greeting and daily interactions",
